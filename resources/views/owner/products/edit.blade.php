            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <span class="text-sm">０から９９の範囲で入力してください</span>
                                </div>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                    ...
                    <form id="delete_{{ $product->id }}" action="{{ route('owner.products.destroy', ['product' => $product->id]) }}" method="post">
                        ...
                        <a href="#" data-id="{{ $product->id }}" onclick="deletePost(this)" type="button" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
