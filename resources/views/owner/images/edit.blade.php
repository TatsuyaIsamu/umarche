            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="delete_{{ $image->id }}" action="{{ route('owner.images.destroy', ['image' => $image->id]) }}" method="post">
                        ...
                        <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" type="button" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
