                    ...
                    <div class="lg:flex lg:justify-around">
                        <div class="lg:flex items-center">
                            <select name="category" class="mb-2 lg:mb-0 lg:mr-2" id="">
                                <option value="0" @if (\Request::get('category') === '0') selected @endif>すべて</option>
                            ...
                            <div class="flex space-x-2 items-center">
                                <div><input name="keyword" class="border border-gray-700 my-2" placeholder="キーワードを入力"></div>
                                        ...
                                        <x-thumbnail filename="{{ $product->filename ?? ''}}" type="products" />
                                            <div class="text-gray-700">
                                                <div class="mt-4">
                                                    ...
                                                    <p class="mt-1">{{ number_format($product->price) }} <span class="text-sm text-gray-700">円（税込み）</span></p>
                                                </div>
                                            </div>
                                    </div>
                                </a>
